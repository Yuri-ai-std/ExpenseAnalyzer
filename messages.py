...
messages = {
    "en": {
        ...
        "add_expense.today_title": "Today’s entries",
        "add_expense.today_empty": "No entries for today yet.",
        ...
        "description).",
        "browse.reset": "Reset",
        "browse.only_present_cats": "Show only present categories",
        "browse.only_present_cats_help": "Limit the list to categories found in the selected date range",
        "browse.search": "Search (description or category)",
        "browse.max_amount_help": "0 means no limit",
    ...
    "es": {
        ...
        "add_expense.today_title": "Entradas de hoy",
        "add_expense.today_empty": "No hay entradas para hoy aún.",
        ...
        "browse.only_present_cats": "Mostrar solo las categorías presentes",
        "browse.only_present_cats_help": "Limitar la lista a las categorías del rango de fechas",
        "browse.search": "Buscar (descripción o categoría)",
        "browse.max_amount_help": "0 significa sin límite",
    ...
    "fr": {
        ...
        "add_expense.today_title": "Entrées d’aujourd’hui",
        "add_expense.today_empty": "Aucune entrée pour aujourd'hui.",
        ...
        "browse.only_present_cats": "Afficher uniquement les catégories présentes",
        "browse.only_present_cats_help": "Limiter la liste aux catégories trouvées dans l’intervalle de dates",
        "browse.search": "Recherche (description ou catégorie)",
        "browse.max_amount_help": "0 signifie sans limite",
